...
FILE: 
    server.c
DESCRIPTION: 
    The implementation of caecar encryption server. 
    In main() function two thread are created, which share one buffer.
    Buffer read and write is protected by mutex.
*/
